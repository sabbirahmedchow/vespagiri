        ...
        <div class="col-lg-8 col-md-12 col-12">
            <div class="post_details_inner">
                <div class="single_post_thumbnail">
                    <img src="/img/blog/large_1.jpg" alt="single post thumbail">
                </div>
                <div class="single_post_content">
                    <div class="single_post_top_contnt">
                        <div class="single_post_title">
                            <h2>Bike safety consultation shows someone in government might understand cycling.</h2>
                        </div>
                        ...
                        <div class="row fix mt-30 mb-30">
                            <div class="col-lg-6 col-md-12 col-xs-12">
                                <div class="post_gallery_img">
                                    <img src="/img/blog/gallery_1.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-xs-12">
