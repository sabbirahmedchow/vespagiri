            ...
            <div class="product-details-img-content">
                <div class="product-details-tab">
                    <div id="img-1" class="zoomWrapper single-zoom">
                        <a href="#">
                            <img id="zoom1" src="/img/product/pro_details/big-2.jpg" data-zoom-image="/img/product/pro_details/z-1.jpg" alt="big-1">
                        </a>
                    </div>
                    <div class="single-zoom-thumb mt-20">
                        <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                            <li>
                                <a href="#" class="elevatezoom-gallery active" data-update="" data-image="/img/product/pro_details/big-2.jpg" data-zoom-image="/img/product/pro_details/z-1.jpg">
                                    <img src="/img/product/pro_details/pro_sm_1.jpg" alt="zo-th-1"/>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="elevatezoom-gallery active" data-update="" data-image="/img/product/pro_details/big-2.jpg" data-zoom-image="/img/product/pro_details/z-1.jpg">
                                    <img src="/img/product/pro_details/pro_sm_2.jpg" alt="zo-th-1"/>
                                </a>
                                
                            </li>
                            <li >
                                <a href="#" class="elevatezoom-gallery active" data-update="" data-image="/img/product/pro_details/big-3.jpg" data-zoom-image="/img/product/pro_details/z-1.jpg">
                                    <img src="/img/product/pro_details/pro_sm_3.jpg" alt="zo-th-1"/>
                                </a>
                                
                            </li>
                            <li >
                                <a href="#" class="elevatezoom-gallery active" data-update="" data-image="/img/product/pro_details/big-4.jpg" data-zoom-image="/img/product/pro_details/z-1.jpg">
                                    <img src="/img/product/pro_details/pro_sm_4.jpg" alt="zo-th-1"/>
                                </a>
                                    ...
                                    <div class="review_comment_box_inner">
                                        <form action="#">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="sure-name" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" id="comments" required></textarea>
                                            </div>
    ...
    <div class="related_product_section mt-100">
        ...
        <div class="row related_product_guttters owl-carousel mt-60">
            <div class="col-lg-3">
                <div class="single__product">
                    <div class="produc_thumb">
                        <a href="#"><img src="/img/product/home2/4.png" alt=""></a>
                    </div>
            ...
            <div class="col-lg-3">
                <div class="single__product">
                    <div class="produc_thumb">
                        <a href="#"><img src="/img/product/home2/5.png" alt=""></a>
                    </div>
                    <div class="product_hover">
                        <div class="product_action">
                            <a href="#" title="Add To Cart"><i class="zmdi zmdi-shopping-cart-plus"></i></a>
            ...
            <div class="col-lg-3">
                <div class="single__product">
                    <div class="produc_thumb">
                        <a href="#"><img src="/img/product/home2/6.png" alt=""></a>
                    </div>
                    <div class="product_hover">
                        <div class="product_action">
                            <a href="#" title="Add To Cart"><i class="zmdi zmdi-shopping-cart-plus"></i></a>
            ...
            <div class="col-lg-3">
                <div class="single__product">
                    <div class="produc_thumb">
                        <a href="#"><img src="/img/product/home2/7.png" alt=""></a>
                    </div>
                    <div class="product_hover">
                        <div class="product_action">
                            <a href="#" title="Add To Cart"><i class="zmdi zmdi-shopping-cart-plus"></i></a>
            ...
            <div class="col-lg-3">
                <div class="single__product">
                    <div class="produc_thumb">
                        <a href="#"><img src="/img/product/home2/8.png" alt=""></a>
                    </div>
                    <div class="product_hover">
                        <div class="product_action">
                            <a href="#" title="Add To Cart"><i class="zmdi zmdi-shopping-cart-plus"></i></a>
            ...
            <div class="col-lg-3">
                <div class="single__product">
                    <div class="produc_thumb">
                        <a href="#"><img src="/img/product/home2/9.png" alt=""></a>
                    </div>
                    <div class="product_hover">
                        <div class="product_action">
                            <a href="#" title="Add To Cart"><i class="zmdi zmdi-shopping-cart-plus"></i></a>
